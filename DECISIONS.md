...
### AGF-007: [Pi] Use Exa API and Gemini API only — disable browser-based fallbacks [Accepted]
...
### AGF-006: [Pi] Introduce pi-web-access extension for web search and content extraction [Accepted]
