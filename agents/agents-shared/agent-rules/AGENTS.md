...
- **Context7 docs skill (`find-docs`)**: Use for library, tooling, and SDK documentation lookups. If docs intent is detected, run `find-docs` before `web_search` or `code_search` unless the user explicitly asks for broad web research.
